                ...
                >
                    <View style={styles.scrollViewContent}>
                        ...
                        <View style={styles.description}>
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                {this.toRate(data.rating).map((star) =>
                                    <Image style={{width: 10, height: 10}}
                                           source={require('../Assets/Images/Icons/ic_starfilled.png')}/>
                                )}
                            ...
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                <Text style={{flex: 1}}>Rp. {data.price}</Text>
                                <TouchableOpacity style={{
                                    ...
                                    <Image style={{width: 15, height: 15, opacity: 0.9}}
                                           source={require('../Assets/Images/Icons/ic_negofill.png')}/>
                        ...
                        <View style={{
                            ...
                            <Image style={{width: 25, height: 25, opacity: 0.7}}
                                   source={require('../Assets/Images/Icons/ic_free_delivery_fee.png')}/>
                        </View>
                        ...
                        <View style={{marginTop: 20}}>
                            <TouchableOpacity style={{
                                ...
                                <Image style={{width: 28, height: 28, opacity: 0.7}}
                                       source={require('../Assets/Images/Icons/ic_cek_ongkir.png')}/>
                                <View style={{flex: 1, marginLeft: 10}}>
                                    <Text>Ongkir mulai Rp11.000</Text>
                                    <Text style={{fontSize: 10}}>Pengiriman ke Batujajar</Text>
                                </View>
                                <Image style={{width: 28, height: 28, opacity: 0.7}}
                                       source={require('../Assets/Images/Icons/ico_chevron_right_minor.png')}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{
                                padding: 10,
                                backgroundColor: '#FFF',
                                ...
                                <Image style={{width: 28, height: 28, opacity: 0.7}}
                                       source={require('../Assets/Images/Icons/ic_installment.png')}/>
                                <View style={{flex: 1, marginLeft: 10}}>
                        ...
                        <View style={{marginTop: 20, backgroundColor: '#FFF', padding: 10}}>
                            <View>
                                ...
                                <View style={{flexDirection: 'row', marginTop: 20}}>
                                    ...
                                    <Text style={{color: '#666', fontSize: 12,}}>>{data.stock}</Text>
                                </View>
                            ...
                            <View style={{margin: 10}}>
                                <View style={{flexDirection: 'row'}}>
                                    <Image style={{width: 15, height: 15}}
                                           source={require('../Assets/Images/Icons/ic_feedback.png')}/>
                                    <Text style={{fontSize: 11, marginLeft: 5}}>99%(1223 feedback)</Text>
                                </View>
                                <View style={{flexDirection: 'row'}}>
                                    <Image style={{width: 15, height: 15}}
                                           source={require('../Assets/Images/Icons/ic_waktu_proses.png')}/>
                ...
                <View style={{borderTopRadius: 1, height: 55, padding: 10, flexDirection: 'row'}}>
                    <TouchableOpacity style={{
                        ...
                        <Image style={{width: 20, height: 20}}
                               source={require('../Assets/Images/Icons/ic_chat_new.png')}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={{
                        width: 35,
                        marginRight: 10,
                        ...
                        <Image style={{width: 20, height: 20}}
                               source={require('../Assets/Images/Icons/ic_addtocart.png')}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={{
                        flex: 1,
                        borderRadius: 5,
                ...
                <Animated.View style={[styles.header, {height: headerHeight}]}>
                    ...
                    <View style={styles.bar}>
                        <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                            <Image source={require('../Assets/Images/Icons/h5_title_bar_back_btn.png')}
