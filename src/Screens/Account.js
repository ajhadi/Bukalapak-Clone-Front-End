                    ...
                    <LinearGradient colors={['#fff', '#929292']} style={styles.gradient}>
                        ...
                        <View style={styles.profile}>
                            <View style={{marginTop: -30, alignItems:'center'}}>
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    ...
                                    <TouchableOpacity style={{justifyContent: 'center'}} onPress={() => {this.props.navigation.navigate('EditProfile')}}>
                                        <Image style={{width: 14, height: 14}} source={require('../Assets/Images/Icons/ico_edit_minor.png')}/>
                                    </TouchableOpacity>
                                </View>
                                <View style={{paddingLeft: 20,paddingRight: 20, paddingBottom: 8, paddingTop: 3, flexDirection: 'row', justifyContent: 'space-between', width: '100%'}}>
                        ...
                        <View style={{height: 515, backgroundColor: '#f9f9f9'}}>
                            <View style={{padding:20, paddingTop:30, alignItems: 'center'}}>
                                <Text style={{fontSize: 16, color:'#000', fontWeight: '500'}}>Ayo, Jualan di Bukalapak!</Text>
                            </View>
                            <TouchableOpacity style={{height: 40, backgroundColor: '#EE4B60', borderRadius: 4, marginLeft:20, marginRight:20, justifyContent: 'center', alignItems: 'center'}}>
