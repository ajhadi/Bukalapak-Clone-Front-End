        ...
        return (
            <View>
                ...
                <ScrollView backgroundColor={'#fff'}>
                    ...
                    <Text style={{fontSize: 12, color: '#bbb', padding: 20}}>Data kamu selalu dirahasiakan dan tidak kami beritahukan kepada pihak ketiga.</Text>
                    ...
                    <Modal transparent={true} visible={this.state._ModalVisible} onRequestClose={() => this.changeModalVisibility(false)}>
                        <TouchableOpacity activeOpacity={1} style={styles.contentSide} onPress={() => this.setModalVisibility(false)} ></TouchableOpacity>
